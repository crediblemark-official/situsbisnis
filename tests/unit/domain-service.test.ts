...
import * as DomainService from '@/modules/domain/services/domain.service';
import { db } from '@/lib/core/db';
import { verifyDomainConfig } from '@/lib/domains/verification';
import { DokployService } from '@/modules/infrastructure/services/dokploy.service';
...
vi.mock('@/modules/infrastructure/services/dokploy.service', () => ({
  DokployService: {
    addDomain: vi.fn(),
    deleteDomain: vi.fn(),
  },
