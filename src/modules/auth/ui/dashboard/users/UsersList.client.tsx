...
import { deleteUserAction, getUsersAction } from "@/modules/auth/public-actions";
            ...
            <div className="w-full animate-in fade-in duration-1000 space-y-6">
                ...
                >
                    <button
                        ...
                        className="flex items-center gap-3 py-1.5 bg-primary text-primary-foreground rounded-lg text-[10px] font-black uppercase tracking-widest hover:opacity-90 transition-all shadow-xl shadow-primary/20 active:scale-95 px-4"
                    >
